...
# arch_image = cv2.imread(main_image)
# flag_image = cv2.imread(image_to_superimpose)
...
map_image = cv2.imread(str(DATA_FOLDER/"sri lanka 3d.jpg"), cv2.IMREAD_COLOR)
flag_image = cv2.imread(str(DATA_FOLDER/"srilankanflag.png"), cv2.IMREAD_COLOR)
